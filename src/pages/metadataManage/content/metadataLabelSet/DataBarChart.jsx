...
const { getListByRecent } = metadataManage.metadataLabel;

const DataBarChart = ({ id }) => {
  ...
  const loadChartData = () => {
    getListByRecent({ tableGatherId: id, flag: true, limit }).then(res => {
  ...
  return (
    <>
      ...
      <div style={{ width: '1200px', height: '600px' }} ref={chartRef}></div>
    </>
  );
};
